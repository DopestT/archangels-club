    ...
    return (
      <div className="min-h-screen bg-bg-primary flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <p className="text-arc-secondary mb-6">This link is missing a token. Use the link from your password reset email.</p>
    ...
    return (
      <div className="min-h-screen bg-bg-primary flex items-center justify-center px-4">
        <div className="max-w-md w-full text-center">
          ...
          <h1 className="font-serif text-3xl text-white mb-3">Password updated.</h1>
          <p className="text-arc-secondary mb-6">Your password has been updated. You can now log in.</p>
          <Link to="/login" className="btn-gold">Go to Login</Link>
        </div>
      </div>
    );
    ...
    <div className="min-h-screen bg-bg-primary flex items-center justify-center px-4">
      <div className="max-w-md w-full">
        <div className="text-center mb-10">
          ...
          <h1 className="font-serif text-3xl text-white mb-2">Create a new password</h1>
          <p className="text-arc-secondary text-sm">Choose a strong password for your account.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            <label className="block text-xs text-arc-secondary mb-1.5">Confirm New Password</label>
            <input
              type={showPw ? 'text' : 'password'}
              value={confirm}
        ...
        <p className="text-center text-xs text-arc-muted mt-6">
          Remembered your password? <Link to="/login" className="text-gold hover:underline">Sign in</Link>
        </p>
      </div>
    </div>
  );
